    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          {/* PANEL MESERO: SOLO ROL MESERO */}
          <Route
            element={
              <RequireRol nombreRol="Mesero" />
            }
          >
          ...
          {/* PANEL ADMIN: CUALQUIER ROL QUE NO SEA MESERO */}
          <Route element={<RequirePermission />}>
            <Route element={<AppLayout />}>
              {/* CONFIGURACIÓN / SUCURSALES */}
              <Route
                element={
                  <RequirePermission permiso="configuracion" />
                }
              >
                <Route
                  index
                ...
                <Route
                  ...
                  element={<CreateSucursalView />}
                />

                <Route
                  path="/sucursal/:sucursalId"
                  element={<SucursalDetailsView />}
                />

                <Route
                  path="/sucursal/:sucursalId/edit"
                  element={<EditSucursalView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja"
                  element={<CajaDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/create"
                  element={<CreateCajaView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/edit"
                  element={<EditCajaView />}
                />
              </Route>
              ...
              <Route
                element={
                  <RequirePermission permiso="usuarios" />
                }
              >
                <Route
                  path="/sucursal/:sucursalId/personal"
                  element={<PersonalSucursalView />}
                />
                ...
                <Route
                  path="/perfilusuario"
                  element={<PerfilUsuarioDetailView />}
                />

                <Route
                  path="/perfilusuario/create"
                  element={<CreatePerfilUsuarioView />}
                />

                <Route
                  path="/perfilusuario/:perfilUsuarioId/edit"
                  element={<EditPerfilUsuarioView />}
                />
              </Route>

              {/* VENTAS / CAJA / APERTURA / CIERRE */}
              <Route
                element={
                  <RequirePermission permiso="ventas" />
                }
              >
                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/apertura"
                  element={<AperturaCajaDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/apertura/create"
                  element={<CreateAperturaCajaView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/apertura/:aperturaId/edit"
                  element={<EditAperturaCajaView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/cierre"
                  element={<CierreCajaDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/cierre/create"
                  element={<CreateCierreCajaView />}
                />

                <Route
                  path="/sucursal/:sucursalId/caja/:cajaId/cierre/:cierreId/edit"
                  element={<EditCierreCajaView />}
                />
              </Route>
              ...
              <Route
                element={
                  <RequirePermission permiso="inventario" />
                }
              >
                <Route
                  path="/sucursal/:sucursalId/almacen"
                  element={<AlmacenDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/almacen/create"
                  element={<CreateAlmacenView />}
                />

                <Route
                  path="/sucursal/:sucursalId/almacen/:almacenId/edit"
                  element={<EditAlmacenView />}
                />

                <Route
                  path="/sucursal/:sucursalId/inventario"
                  element={<InventarioDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/inventario/create"
                  element={<CreateInventarioView />}
                />

                <Route
                  path="/sucursal/:sucursalId/inventario/:inventarioId/edit"
                  element={<EditInventarioView />}
                />

                <Route
                  path="/categoriaProducto"
                  element={<CategoriaProductoDetailView />}
                />

                <Route
                  path="/categoriaProducto/create"
                  element={<CreateCategoriaProductoView />}
                />

                <Route
                  path="/categoriaProducto/:categoriaProductoId/edit"
                  element={<EditCategoriaProductoView />}
                />

                <Route
                  path="/producto"
                  element={<ProductoDetailView />}
                />

                <Route
                  path="/producto/create"
                  element={<CreateProductoView />}
                />

                <Route
                  path="/producto/:productoId/edit"
                  element={<EditProductoView />}
                />

                <Route
                  path="/sucursal/:sucursalId/solicitud"
                  element={<SolicitudDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/solicitud/create"
                  element={<CreateSolicitudView />}
                />

                <Route
                  path="/sucursal/:sucursalId/solicitud/:solicitudId/edit"
                  element={<EditSolicitudView />}
                />

                <Route
                  path="/sucursal/:sucursalId/movimientos"
                  element={<MovimientoDetailView />}
                />
              </Route>
              ...
              <Route
                element={
                  <RequirePermission permiso="egresos" />
                }
              >
                <Route
                  path="/sucursal/:sucursalId/egreso"
                  element={<EgresoDetailView />}
                />

                <Route
                  path="/sucursal/:sucursalId/egreso/create"
                  element={<CreateEgresoView />}
                />

                <Route
                  path="/sucursal/:sucursalId/egreso/:egresoId/edit"
                  element={<EditEgresoView />}
                />
              </Route>
              ...
              <Route
                element={
                  <RequirePermission permiso="reportes" />
                }
              >
                <Route
                  path="/sucursal/:sucursalId/reportes"
                  element={<ReporteDashboardView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/estado-resultados"
                  element={<ReporteEstadoResultadosView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/ventas"
                  element={<ReporteVentasView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/productos"
                  element={<ReporteProductosView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/vendedores"
                  element={<ReporteVendedoresView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/metodos-pago"
                  element={<ReporteMetodosPagoView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/inventario"
                  element={<ReporteInventarioView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/stock-bajo"
                  element={<ReporteStockBajoView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/valor-inventario"
                  element={<ReporteValorInventarioView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/kardex"
                  element={<ReporteKardexView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/flujo-efectivo"
                  element={<ReporteFlujoEfectivoView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/cierres-caja"
                  element={<ReporteCierresCajaView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/solicitudes"
                  element={<ReporteSolicitudesResumenView />}
                />

                <Route
                  path="/sucursal/:sucursalId/reportes/productos-mas-vendidos"
                  element={<ProductoMasVendidoPorSucursalView />}
                />
              </Route>
              ...
              <Route
                path="/perfil/:perfilId/edit"
                element={<EditPerfilView />}
              />
            </Route>
          </Route>
        </Routes>
