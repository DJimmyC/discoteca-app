...
interface RolFormProps {
  ...
  setFormData: React.Dispatch<React.SetStateAction<RolFormData>>;
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
          ...
          {permisos.map((permiso) => {
            ...
            const activo = formData[
              permiso.key as keyof typeof formData
            ] as boolean;
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Permitir acceso al módulo de {permiso.label.toLowerCase()}
                    </p>
                ...
                <button
                  type="button"
                  onClick={() => togglePermission(permiso.key)}
                  className={`
                    mt-6
                    flex
                    w-full
